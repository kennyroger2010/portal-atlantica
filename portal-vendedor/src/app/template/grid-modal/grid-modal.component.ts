...
export class GridModalComponent implements  OnInit, AfterViewInit {
    ...
    constructor(private crudService: CrudService, private router: Router, public dialogRef: MatDialogRef<GridModalComponent>) { }
    ...
    ngOnInit(): void {
      ...
      if (this.page.btnView || this.page.btnEdit || this.page.btnDelete || this.page.btnSelect) {
